...
public class EmployeeStudentRun {
    public static void main(String[] args) {
        ...
        Address a1 = new Address("Czehia", "Olomouc", "Ostrvska 1", 77900);
        ...
        Address a2 = new Address("Czehia", "Praha", "Hrozenkovska 461", 15521);
        BirthDate b2 = new BirthDate(1, 1, 2000);
        Student s2 = new Student(a2, b2, 'M', "Dan Konecny", "Silesian University in Opava", "Computer Science and Technology");
        s2.print();

        System.out.println("\n\n");

        Address a3 = new Address("Czehia", "Opava", "Hradecka 85", 77900);
        ...
        Address a4 = new Address("Czehia", "Praha", "Narodni 1175", 10221);
